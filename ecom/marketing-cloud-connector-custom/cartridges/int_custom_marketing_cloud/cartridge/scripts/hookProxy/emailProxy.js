    ...
    if (emailObj) {
        switch (emailObj.type) {
            ...
            case emailTypes.accountEmailChanged:
                ...
                break;
            case emailTypes.appointmentRequest:
                context.FirstName = context.FirstName;
                params.put('Appointment', context);
                hookID += 'appointment.request';
                break;
            case emailTypes.hearingTest:
                context.FirstName = context.FirstName;
                params.put('HearingTest', context);
                hookID += 'hearingtest.result';
                break;
            default:
