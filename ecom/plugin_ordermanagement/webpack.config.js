...
module.exports = [{
    ...
    output: {
        path: path.resolve('./cartridges/plugin_ordermanagement/cartridge/static'),
        filename: '[name].js'
    },
    resolve: {
        alias: {
            cleave: path.resolve(__dirname, '../storefront-reference-architecture/node_modules/cleave.js')
        }
    }
}, {
    mode: 'none',
