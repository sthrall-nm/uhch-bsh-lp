...
module.exports.render = function (context, modelIn) {
    ...
    model.logo = ImageTransformation.getScaledImage(content.logo);
    model.headline = content.headline ? content.headline : null;
    ...
    return new Template('experience/components/commerce_assets/hero').render(model).text;
};
