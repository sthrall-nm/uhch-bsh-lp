...
/**
 * Render logic for the landing page.
 *
...
module.exports.render = function (context) {
    ...
    var metaDefinition = require('*/cartridge/experience/pages/landingPage.json');
    ...
    // render the page
    return new Template('experience/pages/landingPage').render(model).text;
};
